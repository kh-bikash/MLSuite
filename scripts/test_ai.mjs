...
async function main() {
  ...
  try {
    const result = await generateObject({
      ...
      schema: TestSchema,
      prompt: "Give me a summary and 2 metrics for a fake car. IMPORTANT: You MUST respond ONLY with valid JSON matching the requested schema. Do not include markdown blocks (```json) or any conversational text.",
    });
    console.log("SUCCESS!");
